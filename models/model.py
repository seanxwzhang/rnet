...
class R_NET:
	...
	def build_model(self):
		...
		answer_si_idx = tf.argmax(answer_si, 1)
		answer_ei_idx = tf.argmax(answer_ei, 1)
        ...
        ps1 = tf.argmax(p1, output_type=tf.int32)
        ps2 = tf.argmax(p2, output_type=tf.int32)
		return loss, tf.stack([ps1, ps2])
